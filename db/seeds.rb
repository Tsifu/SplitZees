...
user1 = User.create!(username: "breakfast", password: "breakfast", email: "breakfast@gmail.com")
...
bill4 = Bill.create!(amount: 30, description: "drink", bill_date: Date.parse("Feb 5 2017"), payer_id: guest.id, paid: false)
...
bill20 = Bill.create!(amount: 30, description: "snack", bill_date: Date.parse("Jan 13 2017"), payer_id: friend5.id, paid: true)
